...
.controller('GPSCtrl', function ($scope, $rootScope,socket, $localstorage,ionicDatePicker, ionicTimePicker) {
...
$scope.mode = "live" ; 
$scope.drawMap() ; 
$scope.message = "Waiting for Live Feed ";



}

$scope.showSpecific =function () {
$scope.message = "Showing GPS data for specific duration ";
...
.controller('LogoutCtrl',  function ($scope, $location,$rootScope,$state) {
    ...
    .controller('ImageCtrl', function ($scope, $rootScope, socket, $ionicSlideBoxDelegate) {
